...
setup_environment() {
    local base_dir="/bash-task/task20/symlink_env"
    ...
    declare -A files=(
        ...
        ["$base_dir/dir2/subdir3/file4.txt"]="This is file4 in subdir3."
    )
    ...
    ln -s "../dir1/subdir1" "$base_dir/dir1/subdir2/symlink_to_subdir1_relative"
